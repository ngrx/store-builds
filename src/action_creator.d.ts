import { Creator, ActionCreator, TypedAction, FunctionWithParametersType, PropsReturnType, DisallowTypeProperty } from './models';
...
export declare function createAction<T extends string, P extends any[], R extends object>(type: T, creator: Creator<P, DisallowTypeProperty<R>>): FunctionWithParametersType<P, R & TypedAction<T>> & TypedAction<T>;
