...
export declare function createSelector<State, S1, S2, S3, S4, Result>(s1: Selector<State, S1>, s2: Selector<State, S2>, s3: Selector<State, S3>, s4: Selector<State, S4>, projector: (s1: S1, s2: S2, s3: S3) => Result): MemoizedSelector<State, Result>;
...
export declare function isSelector(v: any): v is MemoizedSelector<any, any>;
